...
$plan=!empty($_REQUEST["plan"])?$_REQUEST["plan"]:"rdc";
...
case "releve" :
	...
	for ($i=0;$i<$num;$i++) {
		$comp = mysql_result($resultat,$i,"composants_id");
		$compnom = mysql_result($resultat,$i,"composants_nom");
		$plan = explode("_",strtolower(mysql_result($resultat,$i,"plan_nomplan")));
