...
echo "<div class='cadresr'><table id='weather' cellpadding='4' cellspacing='0' width='170'><tr>";
...
$res = mysql_query ($sql);
if($res){while($row=mysql_fetch_array($res)){echo ("<tr><td align='center' width='140'>".$row['logs_date']."</td><td align=left>".substr($row['logs_description'],0,100)."...</td></tr>");}}
