...
#Region "Déclaration"
    ...
    Public tempsentrereponse As Integer = 1500
    Public ignoreadresse As Boolean = False
    Public lastetat As Boolean = True
...
#End Region
    ...
    Public Function lancer() As String
        If tcp Then
            ...
            Catch ex As Exception
                WriteLog("ERR: LANCER GETSTREAM : " & ex.Message)
        ...
        Else
            ...
            Catch ex As Exception
                WriteLog("ERR: LANCER Serial : " & ex.Message)
...
#Region "Write"
    ...
    Public Sub WriteLog(ByVal message As String)
        Try
            ...
            End If
        Catch ex As Exception
            domos_svc.log("RFX : WriteLog : " & ex.Message, 2)
        End Try
    End Sub
