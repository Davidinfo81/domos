...
('10', 'log_niveau', '0-1-2-3-4-5-6-9', '0-Prog,1-Err crit,2-Err general,3-Msg reçues,4-Lancement macro/timer,5-Actions macro/timer,6-Valeurs ayant change,7-Valeurs n ayant pas change,8-Valeurs inchange precision/lastetat,9-Divers'),
('11', 'log_dest', '2', '0=txt, 1=sql, 2=txt sql'),
('12', 'meteo_codeville', 'FRXX0076', 'Code Ville Prevision weather.com (FRXX0076)'),
('13', 'meteo_icone', '2', 'Numéro du pack d icones meteo'),
('14', 'meteo_codevillereleve', 'FRXX0076', 'Code Ville Releve weather.com (FRXX0076)'),
('15', 'logs_nbparpage', '1000', 'Nb de logs/Releves à afficher par page'),
...
('27', 'heure_coucher_correction', '0', 'Ajout de x minutes à l heure de couche du soleil'),
('28', 'heure_lever_correction', '0', 'Ajout de x minutes à l heure de leve du soleil'),
